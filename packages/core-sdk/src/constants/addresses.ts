...
export const SICLE_ADDRESS: AddressMap = {
  [ChainId.ETHEREUM]: '0x6B3595068778DD592e39A122f4f5a5cF09C90fE2',
  [ChainId.ROPSTEN]: '0x0769fd68dFb93167989C6f7254cd0D766Fb2841F',
  [ChainId.RINKEBY]: '0x0769fd68dFb93167989C6f7254cd0D766Fb2841F',
  [ChainId.GÖRLI]: '0x0769fd68dFb93167989C6f7254cd0D766Fb2841F',
  ...
  // testnet
  // [ChainId.AVALANCHE]: '0x5F05bB272624bcD1b89A2B3Ae9A01645D1369aE9',
  // [ChainId.AVALANCHE]: '0x8Ebf9469019311F26Cd719fc028e1cf365ab789B',
  // [ChainId.AVALANCHE]: '0xDD08a7996CCAb49c330d6C78ca6199b8399cC64f',
  [ChainId.HECO]: '0x52E00B2dA5Bd7940fFe26B609A42F957f31118D5',
  [ChainId.HARMONY]: '0xBEC775Cb42AbFa4288dE81F387a9b1A3c4Bc552A',
  [ChainId.OKEX]: '0x2218E0D5E0173769F5b4939a3aE423f7e5E4EAB7',
  [ChainId.OKEX_TESTNET]: '',
...
export const FACTORY_ADDRESS: AddressMap = {
  ...
  [ChainId.ARBITRUM]: '0x3BCa0B7431f46050a99Ec3B1B7BB710B3eFd30DD',
  [ChainId.ARBITRUM_TESTNET]: '',
  [ChainId.MOONBEAM_TESTNET]: '0x2Ce3F07dD4c62b56a502E223A7cBE38b1d77A1b5',
  // [ChainId.AVALANCHE]: '0x3bca0b7431f46050a99ec3b1b7bb710b3efd30dd',
  ...
  // testnet
  // [ChainId.AVALANCHE]: '0xA22FFF80baEF689976C55dabb193becdf023B6B9',
  // [ChainId.AVALANCHE]: '0xEe673452BD981966d4799c865a96e0b92A8d0E45',
  [ChainId.AVALANCHE_TESTNET]: '0xd00ae08403B9bbb9124bB305C09058E32C39A48c',
...
export const ROUTER_ADDRESS: AddressMap = {
  ...
  // testnet
  // [ChainId.AVALANCHE]: '0xb7fee4Ed4D9dfe60EFd7ea164315d89FcF0Cd9a8',
  // [ChainId.AVALANCHE]: '0x37Af069Feb93471c99C696B1e111c9c66031F46e',
  // [ChainId.AVALANCHE]: '0x0427b42bb6ae94b488dcf549b390a368f8f69058',
...
export const MASTERCHEF_ADDRESS: AddressMap = {
  ...
  // [ChainId.AVALANCHE]: '0xd345d0608689a52A30ec5405f22a0959F57eB4A1',

  [ChainId.AVALANCHE]: '0xd3344E9a4Bc67de0dF101CEe5B047fe2dc5AF354',
  // testnet
  // [ChainId.AVALANCHE]: '0xa2695f4F6c96f74dB00412D210413C1B94AF0D6f'
  // [ChainId.AVALANCHE]: '0xcbd879DAA863f3D9F6520CA8d00343b901EE725c',
}
...
export const BAR_ADDRESS: AddressMap = {
  ...
  // [ChainId.AVALANCHE]: '0x2fdF064224442Bf4d9913b8d40CaaB555512c22A',

  //mainnet
  [ChainId.AVALANCHE]: '0x5108176bC1B7e72440e6B48862c51d7eB0AEd5c4',
  //testnet
  // [ChainId.AVALANCHE]: '0xE061D30E6Bb4F074309a644a4a00453F062e7CD3'
  // [ChainId.AVALANCHE]: '0x3DdCbDC3F0806b70B89EA4b27E23506Eb9FE36FE',
}
...
export const MAKER_ADDRESS: AddressMap = {
  ...
  //mainnet
  [ChainId.AVALANCHE]: '0x8F0d1e091aC53A2C4143C1ecC1067F7E337680D3',
  // testnet
  // [ChainId.AVALANCHE]: '0x837BD84F122EB1A1De6a9c424FDC8A23Bb38e59A',
  // [ChainId.AVALANCHE]: '0x93D38007f789115bAe810d8b7A16F6B3D8651878',
  // [ChainId.AVALANCHE]: '0x29312e06DFd18044dABdA6e8289a853544C8dA82',
}
